...
def get_levels():
    ...
    level_3 = {
        "blocks": [
            ...
            Block(position=[5, 0], orientation='v', colour=Yellow, size=3, block_id=2),
            Block(position=[3, 3], orientation='v', colour=Yellow, size=3, block_id=3),
            Block(position=[4, 5], orientation='h', colour=Yellow, size=2, block_id=4)
        ]
    }
    ...
    level_4 = {
        "blocks": [
            ...
            Block(position=[2, 0], orientation='v', colour=Yellow, size=3, block_id=2),
            Block(position=[0, 5], orientation='h', colour=Yellow, size=3, block_id=3),
            Block(position=[5, 3], orientation='v', colour=Yellow, size=3, block_id=4)
        ]
    }
    ...
    level_5 = {
        "blocks": [
            Block(position=[0, 2], orientation='h', colour=Red, size=2, block_id=1),
            Block(position=[1, 3], orientation='v', colour=Yellow, size=2, block_id=2),
            Block(position=[2, 4], orientation='h', colour=Yellow, size=2, block_id=3),
            Block(position=[3, 0], orientation='v', colour=Yellow, size=3, block_id=4),
            Block(position=[5, 2], orientation='v', colour=Yellow, size=3, block_id=5),
        ]
    }
    ...
    level_6 = {
        "blocks": [
            ...
            Block(position=[1, 4], orientation='h', colour=Yellow, size=2, block_id=3),
            Block(position=[1, 4], orientation='v', colour=Yellow, size=2, block_id=4),
            Block(position=[2, 3], orientation='v', colour=Yellow, size=2, block_id=5),
            Block(position=[2, 5], orientation='h', colour=Yellow, size=2, block_id=6),
            Block(position=[3, 1], orientation='v', colour=Yellow, size=3, block_id=7),
            Block(position=[5, 1], orientation='v', colour=Yellow, size=3, block_id=8),
